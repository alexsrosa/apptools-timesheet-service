...
public class ViewTimeSheetService {
	...
	public List<ViewTimeSheet> findByDataByDataAsc(String data1, String data2) {
		return this.repository.findByDataByDataAsc(data1, data2);
	}

	public List<ViewTimeSheet> findAll() {
